...
insert into customer_info(id,first_name,last_name,salary) values(1,"Krish","Naik",20000);
...
insert into employee(id,housenumber,pancard,first_name,last_name,salary) values(1,1,1,"Krish","Naik",20000);

insert into employee values(2,2,1,"Krish1","NAik1",20000);
...
insert into student(first_name,last_name) values("Krish","Naik"),("Krish","Naik");
...
(3,"Sunny","Savitha",30),(4,"Darius","Bengali",27);
